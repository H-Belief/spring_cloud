...
public class ExcelUtilServer {
    ...
    public static byte[] downloadExcelFile(String title, Map<String, String> headMap, JSONArray ja) {
        try {
            ...
            ExcelUtilServer.exportExcelX(title, headMap, ja, null, 0, os);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ExcelUtilServer.exportExcelX("test", headMap, jsa, null, 0, out);
